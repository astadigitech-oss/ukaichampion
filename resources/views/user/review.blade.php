...
@section('content')
    ...
    <div id="imageLightboxModal"
        class="hidden fixed inset-0 w-full h-full bg-black/90 flex-col items-center justify-center p-4 md:p-8 cursor-zoom-out"
        style="z-index: 2147483647 !important;" onclick="closeLightbox()">
    ...
    <div class="w-full px-4 md:px-8 relative z-10 mb-12 mt-4">
        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-200 text-center flex items-center gap-3">
                                                ...
                                                <div
                                                    ...
                                                    @if ($q->is_answer_image)
                                                        @php
                                                            ...
                                                            $cleanOptPath = ltrim(
                                                                str_replace(['/storage/', 'storage/'], '', $optText),
                                                                '/',
                                                            );
                                                        @endphp
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // 1. PINDAHKAN MODAL SECARA PAKSA KE BODY (Biar menang dari Sidebar)
            const modalUtama = document.getElementById('examLightboxModal');
            if (modalUtama) {
                document.body.appendChild(modalUtama);
            }

            // 2. Jalankan fungsi zoom bawaanmu
            initializeImageZoom();
        });
